...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-10 21:31:51 UTC<br>状态：成功</p>
</section>
...
<p>今日精读1篇9.0分论文，聚焦运筹学语言模型的引导式自蒸馏方法。该研究提出Solver-Informed Self-Distillation，突破仅依赖已验证答案的局限，为运筹学LLM冷启动提供新思路。普通读者可关注&quot;用求解器信号反哺模型训练&quot;这一方向，并留意其在具体运筹任务上的落地验证。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Beyond Verified Answers: Solver-Informed Self-Distillation for Bootstrapping Operations Research Language Models">Beyond Verified Answers: Solver-Informed Self-Distillation for Bootstrapping Operations Research Language Models</span></li></ul>
  </div>
