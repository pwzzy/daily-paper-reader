...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-22 21:42:00 UTC<br>状态：成功</p>
</section>
...
<p>精读：《OptiSkill: A Hierarchical and Evolving SkillBank for LLM-Based Optimization Modeling》（10.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="OptiSkill: A Hierarchical and Evolving SkillBank for LLM-Based Optimization Modeling">OptiSkill: A Hierarchical and Evolving SkillBank for LLM-Based Optimization Modeling</span></li></ul>
  </div>
